...
A light ray goes from $A$ to $B$ passing through $C$.
Let $v_1$ be the velocity in air and $v_2$ the velocity in glass.
...
To find $C$ that minimizes $t$,
differentiate $t$ with respect to $y$ and set to zero
\begin{equation*}
